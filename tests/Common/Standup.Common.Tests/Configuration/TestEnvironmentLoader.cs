// <copyright file="TestEnvironmentLoader.cs" company="Standup">
...
public static class TestEnvironmentLoader
{
    ...
    /// </summary>
    /// <param name="customEnvPath">Optional custom path to .env file.</param>
    ...
    /// </summary>
    /// <param name="envPath">Path to the .env file.</param>
