...
public class StandupApiClient : IStandupApiClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await _httpClient.PostAsJsonAsync("/api/standup/generate", command, cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await _httpClient.PostAsJsonAsync("/api/standup/repositories", command, cancellationToken);
        response.EnsureSuccessStatusCode();
