...
public partial class StandupViewModel : ObservableObject
{
    ...
    private Task GenerateRepoOnTheFlyAsync(GroupedRepository repo) => GenerateRepoOnTheFlyInternalAsync(repo);
    ...
    private Task GenerateGroupedStandupAsync() => GenerateGroupedStandupInternalAsync();
